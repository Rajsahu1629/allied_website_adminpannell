...
import CompanyProfileModal from "../modals/CreateAndUpdateModal/CompanyProfileModal";
import {
  fetchGetRequest,
  sendPostRequest,
  sendPutRequest,
...
import PublicationModal from "../modals/CreateAndUpdateModal/PublicationModal";
import TrustCircleModal from "../modals/CreateAndUpdateModal/TrustCircleModal";
import FormerParticipantmodal from "../modals/CreateAndUpdateModal/FormerParticipantmodal";
import FormerParticipantDeleteModal from "../modals/DeleteModals/FormerParticipantDeletemodal";
...
const FormerParticipant = () => {
  ...
  const fetchProfiles = async () => {
    ...
    try {
      ...
      const res = await fetchGetRequest(
        "/api/former-participation/get-former-participations",
        params
      );
      if (res) {
        ...
        setTotalProfiles(res.totalParticipations || (res.data ? res.data.length : 0));
      }
    } catch (error) {
  ...
  const handleMainBannerUpload = async (e) => {
    ...
    try {
      const res = await fetch(
        ...
        }/api/former-participation/section/update`,
        {
          method: "PUT",
          body: formData,
        }
  ...
  const handleDeleteProfile = async (id) => {
    ...
    try {
      const res = await fetch(
        `${
          import.meta.env.VITE_API_BASE_URL
        }/api/former-participation/delete-former-participation/${id}`,
        {
          method: "DELETE",
        }
      );
  ...
  const handleSubmit = async (id, formData) => {
    ...
    try {
      ...
      const url = id
        ? `${
            import.meta.env.VITE_API_BASE_URL
          }/api/former-participation/update-former-participation/${id}`
        : `${
            import.meta.env.VITE_API_BASE_URL
          }/api/former-participation/create-former-participation`;
  ...
  const handleOrderUpdate = async (profileId) => {
    ...
    try {
      const res = await fetch(
        `${import.meta.env.VITE_API_BASE_URL}/api/former-participation/update-former-participation/${profileId}`,
        {
          method: "PUT",
  ...
  return (
    <div className="min-h-screen bg-gray-50/50 w-full overflow-hidden">
      <div className="w-full px-4 sm:px-6 py-6">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-2xl font-semibold text-gray-800">Former Participants</h1>
          <p className="text-gray-500 mt-1">Manage your company's Former Participants</p>
        </div>
...
export default FormerParticipant;