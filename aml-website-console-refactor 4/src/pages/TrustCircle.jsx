...
const TrustCircle = () => {
  ...
  const handleMainBannerUpload = async (e) => {
    ...
    try {
      const res = await fetch(
        ...
        }/api/publications/section/update`,
        {
          method: "PUT",
          body: formData,
        }
  ...
  const handleDeleteProfile = async (id) => {
    ...
    try {
      const res = await fetch(
        `${
          import.meta.env.VITE_API_BASE_URL
        }/api/company-profile/delete-profile/${id}`,
        {
          method: "DELETE",
        }
      );
  ...
  const handleSubmit = async (id, formData) => {
    ...
    try {
      ...
      const url = id
        ? `${
            import.meta.env.VITE_API_BASE_URL
          }/api/company-profile/update-profile/${id}`
        : `${
            import.meta.env.VITE_API_BASE_URL
          }/api/company-profile/create-profile`;
  ...
  const handleOrderUpdate = async (profileId) => {
    ...
    try {
      const res = await fetch(
        `${import.meta.env.VITE_API_BASE_URL}/api/company-profile/update-profile/${profileId}`,
        {
          method: "PUT",
    ...
    <div className="min-h-screen bg-gray-50/50 w-full overflow-hidden">
      <div className="w-full px-4 sm:px-6 py-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-1">Manage your company's public presence</p>
        </div>
